...
export default function CardTramite() {
  ...
  const handleTramitesDatils = () => {
    router.push("/auth/formalities/1");
  };
  return (
    <div>
      <div className="p-6 bg-gray-100 mb-5">
        {/* <!-- Header --> */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Tramites</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Trámites Activos</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500">Documentos Observados</p>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-6 mt-4 text-sm text-gray-500">
                    <span>Responsable: Alejandro</span>

                    <span>Fecha: 18/05/2026</span>
                  </div>
                </div>

                <button
                  className="px-4 py-2 text-sm bg-gray-100 hover:bg-gray-200 rounded-lg transition"
                  onClick={() => handleTramitesDatils()}
                >
                  Ver detalle
                </button>
              </div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-4 text-sm text-gray-500">
                    <span>Responsable: Ana Torres</span>

                    <span>Fecha: 17/05/2026</span>
                  </div>
                </div>
            ...
            <div className="p-6 hover:bg-gray-50 transition">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-4 mt-4 text-sm text-gray-500">
                    <span>Responsable: Carlos Mendoza</span>

                    <span>Fecha: 16/05/2026</span>
                  </div>
                </div>
